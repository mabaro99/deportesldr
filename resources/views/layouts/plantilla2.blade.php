        ...
        <div class="container-fluid m-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active link-light" aria-current="page" href="principal">Reserva</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-light" href="competiciones">Competiciones</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            {{-- <li><a class="dropdown-item" href="#">Mis Competiones</a></li> --}}
